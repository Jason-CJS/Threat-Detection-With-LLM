...
# MAGIC %sql SELECT current_schema();
...
from pyspark.sql import Row
from pyspark.sql.types import (
    StructType, StructField, LongType, TimestampType, StringType, MapType
)
from datetime import datetime, timedelta
import random
...
date = datetime.now()
ip = "10.25.50.33"
alert_details = {"IP": ip, "Details": f"Unusual Access detected from {ip}"}

new_alert_row = {
    "ID": 34239,
    "date": date,
    "alert_name": "Unusual Access",
    "alert_desc": "Unusual Access detected",
    "alert_status": "Open",
    "alert_source": "Network",
    "alert_category": "Access",
    "alert_subcategory": "Location",
    "tags": "tag",
    "entity_id": "kristindahl",
    "entity_type": "Users",
    "alert_details": alert_details
}
...
new_alert_row = {
    "ID": 34239,
    "date": date,
    "alert_name": "Data Exfiltrations",
    "alert_desc": "Data Exfiltration detected",
    "alert_status": "Open",
    "alert_source": "Network",
    "alert_category": "Transfer",
    "alert_subcategory": "Exfiltration",
    "tags": "tag",
    "entity_id": "kristindahl",
    "entity_type": "Users",
    "alert_details": alert_details
